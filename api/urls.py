...
from api.views import CommentApiView, CommentToggleApiView, PostToggleApiView, ReplyCommentApiView, SearchPostsApiView, \
    FollowsApiView, BookmarkApiView, ChangeDataView, ChangePasswordView, ThemeFollowsApiView, GetFilterPostsApiView

urlpatterns = [
    path('comments/<int:pk>/', CommentApiView.as_view()),
    path('comments/<int:comment_pk>/<int:post_pk>/delete/', CommentApiView.as_view()),
    ...
    path('reply-comments/<int:pk>/delete/', ReplyCommentApiView.as_view()),
    path('token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
    path('token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    path('search/posts/', SearchPostsApiView.as_view()),
    path('follows/<int:id>/', FollowsApiView.as_view()),
    path('theme_follows/<int:id>/', ThemeFollowsApiView.as_view()),
